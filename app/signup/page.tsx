      ...
      <div className={styles.card}>
        ...
        {step === 1 ? (
          ...
          <form onSubmit={handleRegister}>
             <div className={styles.formGroup}>
                <div className={styles.labelRow}>
                  <label className={styles.label}>Enter 6-digit OTP sent to <strong style={{ color: '#7c6ef5' }}>{email}</strong></label>
                </div>
                <div className={styles.inputWrapper}>
                  <div className={styles.inputIcon}>
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <button type="submit" className={styles.loginBtn} disabled={loading}>{loading ? 'Verifying...' : 'Verify & Register'}</button>
