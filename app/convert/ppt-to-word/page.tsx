        ...
        <div className={styles.heroContainer}>
          ...
          <div className={styles.heroContentWrapper}>
            ...
            <div className={styles.heroText}>
              <h1 className={styles.title}>PPT to Word</h1>
              <p className={styles.subtitle}>
                Convert your presentation slides into editable Word documents while preserving text layout and structure. Perfect for creating meeting handouts.
              </p>
            </div>
            ...
            <section className={styles.featuresSection}>
              ...
              <div className={styles.featuresGrid}>
                ...
                <div className={styles.featureCard}>
                  ...
                  <h3 className={styles.featureCardTitle}>Editable Text</h3>
                  <p className={styles.featureCardDesc}>
                    Extract text and structures seamlessly. Your resulting Word document will be fully editable without losing original formatting.
                  </p>
                </div>
                ...
                <div className={styles.featureCard}>
                  ...
                  <h3 className={styles.featureCardTitle}>Formatting Preserved</h3>
                  <p className={styles.featureCardDesc}>
                    Our conversion engine accurately translates slide layouts into pages, ensuring lists, tables, and images stay in place.
                  </p>
                </div>
